 ...
 * Name:TYSS_GIM_HJ_0016 
 * Description:Verify the status of LOB HR for 'HCL Jewels' allowance 
   claim after getting approved by all the approvers.
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_HJ_0016 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from HCLJewels where SlNo='16'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of LOB HR for 'HCL Jewles' allowance claim after getting approved by all the approvers using through the form option" )
	public void TC_TYSS_GIM_HJ_0016(String slNo,String employeeCode, String countryCode, String companyCode,
