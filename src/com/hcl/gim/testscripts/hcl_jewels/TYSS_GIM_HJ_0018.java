...
/*
 * TestCaseId:TYSS_GIM_HJ_0018 
 * Claim Type:HCL Jewels TestSCript
 * Name:TYSS_GIM_HJ_0018 
 * Description:Verify the status of LOB HR for 'HCL Jewels' allowance claim after getting referred back ES1 OnSite
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_HJ_0018 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from HCLJewels where SlNo='18'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of LOB HR for 'HCL Jewles' allowance claim after getting referred back by ES1 OnSite using through the form option")
	public void TC_TYSS_GIM_HJ_0018(String slNo,String employeeCode, String countryCode, String companyCode,
