...
/*
 * TestCaseId:TYSS_GIM_HJ_0019
 * Claim Type:HCL Jewels TestSCript
 * Name:TYSS_GIM_HJ_0019 
 * Description:Verify the status of LOB HR for 'HCL Jewels' allowance claim after getting referred back ES2 OnSite
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_HJ_0019 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from HCLJewels where SlNo='19'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of LOB HR for 'HCL Jewles' allowance claim after getting referred back by ES2 OnSite using through the form option" )
	public void TC_TYSS_GIM_HJ_0019(String slNo,String employeeCode, String countryCode, String companyCode,
