 ...
 * Name:TYSS_GIM_HJ_0013 
 * Description:Verify the Status of LOB HR for 'HCL Jewels' allowance claim after getting referred back by ES2 OnSite.
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_HJ_0013 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from HCLJewels where SlNo='13'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of LOB HR for 'HCL Jewles' allowance claim after getting referred back by ES2 OnSite using excel upload option" )
	public synchronized void TC_TYSS_GIM_HJ_0013(String slNo,String employeeCode, String countryCode,
