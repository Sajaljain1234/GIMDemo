...
/*
 * TestCaseId:TYSS_GIM_HJ_0014 
 * Claim Type:HCL Jewels TestSCript
 * Name:TYSS_GIM_HJ_0014 
 * Description:Verify that User is able to go back to the select claim page after selecting the 'HCL Jewels allowance' Claim.
 * 
 * @author suganthini
 *
 */
public class TYSS_GIM_HJ_0014 extends BaseTest {
	@Test(description = "Description: Verify that user is able to go back to the select claim page after selecting the 'HCL Jewles' allowance claim in excel upload option")
	public synchronized void TC_TYSS_GIM_HJ_0014() {
