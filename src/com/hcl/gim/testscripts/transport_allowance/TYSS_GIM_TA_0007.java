...
/**
 * TestCase ID : TYSS_GIM_0007
 * Claim Name : Transport Allowance
 * TesScript Name : TYSS_GIM_TA_0007
 * Description : Verify the status of GEO HR for Transport after getting referred back by GEO HR RM
 * @author vikas.kc
 *
 */
public class TYSS_GIM_TA_0007 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from TransportAllowance where SlNo ='7'")
	...
	public synchronized void TC_TYSS_GIM_TA_0007(String slNo, String employeeCode, String countryCode, String companyCode,  String amount, 
...
//		String  claimID = "21";
		...
		pages.pendingActionsPage.clickOnViewDocumentIcon(claimID, WebActionUtil.getSampleFileName(prop_app_constants.getProperty("fileFormat_msg")), prop_app_constants.getProperty("fileFormat_msg"));
