...
/**
 * TestCase ID : TYSS_GIM_0024
 * Claim Name : Transport Allowance
 * TesScript Name : TYSS_GIM_TA_0024
 * Description : Verify the status of GEO HR for Transport after getting referred back by ES2 Onsite
 * @author vikas.kc
 *
 */
public class TYSS_GIM_TA_0024 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from TransportAllowance where SlNo ='24'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Description: Verify the status of GEO HR for Transport after getting referred back by ES2 Onsite")
	
	public synchronized void TC_TYSS_GIM_TA_0024(String slNo, String employeeCode, String countryCode, String companyCode,  String amount, 
