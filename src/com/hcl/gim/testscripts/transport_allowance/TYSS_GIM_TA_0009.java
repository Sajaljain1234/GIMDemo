...
/**
 * TestCase ID : TYSS_GIM_0009
 * Claim Name : Transport Allowance
 * TesScript Name : TYSS_GIM_TA_0009
 * Description : Verify the status of GEO HR for Transport after getting referred back by ES2 Onsite
 * @author vikas.kc
 *
 */
public class TYSS_GIM_TA_0009 extends BaseTest{

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from TransportAllowance where SlNo ='9'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Description: Verify the status of GEO HR after getting referred back by ES2 Onsite")

	public synchronized void TC_TYSS_GIM_TA_0009(String slNo, String employeeCode, String countryCode, String companyCode,  String amount, 
...
//		String claimID = "10";
		...
		/* Verify Claim removed from page or not */
		pages.initiateClaimsPage.verifyClaimID(claimID);

		expectedHistory.add(new String [] {prop_app_constants.getProperty("historyStatus_approved"), prop_app_constants.getProperty("roleES1OnSite"), eS1LoginCredentials[0]});
		...
		/* Click on Pending For Approval on ES2 Onsite Card */
		pages.pendingActionsPage.clkPendingforApprovalTab();
