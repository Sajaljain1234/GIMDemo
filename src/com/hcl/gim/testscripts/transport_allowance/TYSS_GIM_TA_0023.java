...
/**
 * TestCase ID : TYSS_GIM_0023
 * Claim Name : Transport Allowance
 * TesScript Name : TYSS_GIM_TA_0023
 * Description : Verify the status of GEO HR for Transport after getting referred back by ES1 Onsite
 * @author vikas.kc
 *
 */
public class TYSS_GIM_TA_0023 extends BaseTest {
	
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from TransportAllowance where SlNo ='23'")
	...
	public synchronized void TC_TYSS_GIM_TA_0023(String slNo, String employeeCode, String countryCode, String companyCode,  String amount, 
