...
/**
 * TestCase ID : TYSS_GIM_0016
 * Claim Name : Transport Allowance
 * TesScript Name : TYSS_GIM_TA_0016
 * Description : Verify the status of GEO HR for Transport after getting referred back by ES1 Onsite
 * @author vikas.kc
 *
 */
public class TYSS_GIM_TA_0016 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from TransportAllowance where SlNo ='16'")
	...
	public synchronized void TC_TYSS_GIM_TA_0016(String slNo, String employeeCode, String countryCode, String companyCode,  String amount, 
