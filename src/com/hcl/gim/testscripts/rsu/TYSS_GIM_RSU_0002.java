...
/***
 * TestCaseID:TYSS_GIM_0002 Claim Type:RSU Payment(Restricted Stock Units) Test
 * Script Name:TYSS_GIM_RSU_0002
 * 
 * @author Vivek dogra
 * Description: Verify the status of LOB HR for RSU Payment(Restricted Stock Units) after getting approved by all approvers.
 * 
 */
public class TYSS_GIM_RSU_0002 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from RSUPaymentRestrictedStock where SlNo ='2'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description="Description: Verify the status of LOB HR for RSU Payment(Restricted Stock Units) after getting approved by all approvers.")
	public synchronized void TC_TYSS_GIM_RSU_0002(String slNo,String employeeCode, String countryCode,
