...
/***
 * TestCaseID:TYSS_GIM_0010 Claim Type:RSU Payment(Restricted Stock Units) Test
 ...
 * 
 */
public class TYSS_GIM_RSU_0010 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from RSUPaymentRestrictedStock where SlNo ='10'")
	...
	public synchronized void TC_TYSS_GIM_RSU_0010(String slNo,String employeeCode, String countryCode,
