...
/***
 * TestCaseID:TYSS_GIM_0016 Claim Type:RSU Payment(Restricted Stock Units) Test
 * Script Name:TYSS_GIM_RSU_0016
 * 
 * @author Vivek dogra 
 * Description: Verify the status of LOB HR for RSUPayment(Restricted Stock Units) after getting approved by all approvers.
 * 
 */
public class TYSS_GIM_RSU_0016 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from RSUPaymentRestrictedStock where SlNo='16'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description="Description: Verify the status of LOB HR for RSUPayment(Restricted Stock Units) after getting approved by all approvers.")
	public synchronized void TC_TYSS_GIM_RSU_0016(String slNo,String employeeCode, String countryCode,
		...
		pages.throughTheFormPage.fillTheRSUPayment(fromDate, toDate, employeeCode, countryCode, companyCode, amount,
				remarks, WebActionUtil.getSampleFilePath(prop_app_constants.getProperty("fileFormat_jpeg")));
