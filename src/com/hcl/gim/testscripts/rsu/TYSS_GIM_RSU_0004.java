...
/***
 * TestCaseID:TYSS_GIM_0004 Claim Type:Client RSU Payment(Restricted Stock
 * Units) Test Script Name:TYSS_GIM_RSU_0004
 * 
 * @author Vivek dogra 
 * Description: Verify the status of LOB HR for RSUPayment(Restricted Stock Units) after getting referred back by ES1 Onsite
 * 
 */
public class TYSS_GIM_RSU_0004 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from RSUPaymentRestrictedStock where SlNo ='4'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description="Description: Verify the status of LOB HR for RSUPayment(Restricted Stock Units) after getting referred back by ES1 Onsite")
	public synchronized void TC_TYSS_GIM_RSU_0004(String slNo,String employeeCode, String countryCode,
