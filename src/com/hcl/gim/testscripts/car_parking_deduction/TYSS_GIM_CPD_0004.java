...
/**
 * TestCaseId:TYSS_GIM_0004 Claim Type:Car parking Deduction" TestSCript
 * Name:TYSS_GIM_CPD_0004 Description:Verify that User is able to go back to the
 * Select Claim Page after Selecting the 'Car parking Deduction allowance'
 * Claim.
 * 
 * @author Vivek Dogra
 *
 */
public class TYSS_GIM_CPD_0004 extends BaseTest {
	
	@Test(description = "Description:Verify that User is able to go back to the Select Claim Page after Selecting the 'Car parking Deduction allowance' ")
	public synchronized void TC_TYSS_GIM_CPD_0004() {
