...
/**
 * TestCaseId:TYSS_GIM_0011 Claim Type:Car parking Deduction
 * TestSCriptName:TYSS_GIM_CPD_0011 
 * Description:Verify the status of GEO HR for 'Car Parking Deduction' allowance' claim after getting approved by all the approvers
 * @author Vivek Dogra
 *
 */
public class TYSS_GIM_CPD_0011 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from CarParkingDeduction where SlNo='11'")
	...
	public synchronized void TC_TYSS_GIM_CPD_0011(String slNo,String employeeCode, String countryCode,
