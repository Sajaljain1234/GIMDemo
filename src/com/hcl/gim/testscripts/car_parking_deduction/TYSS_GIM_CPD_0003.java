...
/**
 * TestCaseId: TYSS_GIM_003 Claim Type: Car parking Deduction TestScript Name:
 * TYSS_GIM_CPD_0003 Description: Verify that User is able to initiate the 'Car
 * parking Deduction allowance' Claim by writing the Data in the Copy & Paste
 * field.
 * 
 * Author: Vivek Dogra
 */
public class TYSS_GIM_CPD_0003 extends BaseTest {
	
	@Test(description = "Description:Verify that User is able to initiate the 'Car parking Deduction allowance' Claim by writing the Data in the Copy & Paste feild ")
	public synchronized void TC_TYSS_GIM_CPD_0003(){
