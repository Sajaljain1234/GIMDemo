...
/***
 * TestCaseID:TYSS_GIM_0005 Claim Type:Client Bonus/Reward/Incentive Test Script
 * Name:TYSS_GIM_CBRI_0005
 * 
 * @author shreya.u Description: Verify the status of LOB HR for Client
 *         Bonus/Reward/Incentive after getting referred back by ES2 On site
 * 
 */

public class TYSS_GIM_CBRI_0005 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from ClientBonusRewardIncentive SlNo ='5'")
	...
	public synchronized void TC_TYSS_GIM_CBRI_0005(String slNo,String employeeCode, String countryCode,
		...
		/*
		 * Validate Initiate Claim Page is displayed * /* Select Claim Type Drop down
		 */
		...
		/* Click on Close button in HCL Partner Manual Popup */
		...
		/*Validate the claim is moved to next level*/
