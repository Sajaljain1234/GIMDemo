...
/***
 * TestCaseID:TYSS_GIM_0012 Claim Type:Client Bonus/Reward/Incentive Test Script
 * Name:TYSS_GIM_CBRI_0012
 * 
 * @author shreya.u Description: Verify the status of the LOB HR for Client
 *         Bonus/Reward/Incentive claim after getting referred back by ES1 on
 *         site
 * 
 */
public class TYSS_GIM_CBRI_0012 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from ClientBonusRewardIncentive where SlNo ='12'")
	...
	public synchronized void TC_TYSS_GIM_CBRI_0012(String slNo,String employeeCode, String countryCode,
