...
/***
 * TestCaseID:TYSS_GIM_0018 Claim Type:Client Bonus/Reward/Incentive Test Script
 * Name:TYSS_GIM_CBRI_0018
 * 
 * @author shreya.u Description: Verify the status of the LOB HR for the Client
 *         Bonus/Reward/Incentive allowance after getting referred back by ES1
 *         on site.
 * 
 */
public class TYSS_GIM_CBRI_0018 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from ClientBonusRewardIncentive where SlNo ='18'")
	...
	public synchronized void TC_TYSS_GIM_CBRI_0018(String slNo,String employeeCode, String countryCode, String companyCode,
