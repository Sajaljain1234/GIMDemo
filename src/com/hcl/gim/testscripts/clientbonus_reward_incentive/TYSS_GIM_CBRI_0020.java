 ...
 * Test Script Name:TYSS_GIM_CBRI_0020
 * @author shreya.u
 * Description: Verify the user is able to go back to the Select claim page after selecting Client Bonus/Reward/Incentive.
 * 
 */
public class TYSS_GIM_CBRI_0020 extends BaseTest{
@Test(description="Description:Verify that the user is able to go back to the select claim page after selecting the Client Bonus/Reward/Incentive")
	public synchronized void TC_TYSS_GIM_CBRI_0020() {
