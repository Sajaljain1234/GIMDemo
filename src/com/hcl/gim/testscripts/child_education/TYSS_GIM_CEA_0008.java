...
/**
 * TestCaseId: TYSS_GIM_CEA_0008 Claim Type: Child Education Allowance
 * TestScript Name: TYSS_GIM_CEA_0008 Description: Verify that On Site Employee
 * Can Raise the Child Education Claim For the First Time for Tuition
 * Fees-Exception Case.
 * 
 * Author: Manish Kumar C D.
 */

public class TYSS_GIM_CEA_0008 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from ChildEducationAllowance where SlNo ='8'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify that On Site Employee can raise the Child Education Claim for the First Time for Tuition  Fees-Exception Case.")
	public synchronized void TC_TYSS_GIM_CEA_0008(String slNo,String empCode, String childName, String academicYear, String fromDate,String toDate, String grade, String amount, String schoolName, String remarks,String fileFormat) {
		...
		pages.childEducationAllowancePage.applytuitionFeesExceptionalCase(childName, academicYear, fromDate, toDate, grade, amount,schoolName, remarks, WebActionUtil.getSampleFilePath(fileFormat));

		/* click on Exception Yes Button */
