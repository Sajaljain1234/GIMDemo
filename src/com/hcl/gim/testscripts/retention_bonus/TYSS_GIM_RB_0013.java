...
/**
 *TestCaseId: TYSS_GIM__0013
 *Claim Type: RetentionBonus
 *TestScript Name: TYSS_GIM_RB_0013
 *Description: verify that user is able to cancel the claim for which the data is uploaded by GEO HR
 *Author: Abhilash B
 */
public class TYSS_GIM_RB_0013 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from RetentionBonus where SlNo ='13'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description="Description:verify that user is able to cancel the claim for which the data is uploaded(Excel upload)")
	public synchronized void TC_TYSS_GIM_RB_0013(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String bonusperiod,String remarks) throws InterruptedException  

	 {
		...
		/* Click on cancel button Under the Actions Tab for the Uploaded Claim. */
