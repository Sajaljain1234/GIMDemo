...
/**
 *TestCaseId: TYSS_GIM__0007
 *Claim Type: RetentionBonus
 *TestScript Name: TYSS_GIM_RB_0007
 *Description: verify the status of the Geo HR for Retention Bonus after referred back by ES1
 *Author: Abhilash B
 */

public class TYSS_GIM_RB_0007 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from RetentionBonus where SlNo ='7'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description="Description:verify the status of  Retention Bonus claim after referred back by ES1(copypaste)")
	public void TC_TYSS_GIM_RB_0007(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String bonusperiod,String remarks) throws InterruptedException  
 {
			...
			lstHistoryExpectedData.add(new String[] {prop_app_constants.getProperty("historyStatus_approved"), prop_app_constants.getProperty("roleGEOHR"), geoHrLoginDetails[0]});
			...
			pages.pendingActionsPage.clickOnViewDocumentIcon(claimId, WebActionUtil.getSampleFileName(prop_app_constants.getProperty("fileFormat_pdf")),prop_app_constants.getProperty("fileFormat_pdf"));
