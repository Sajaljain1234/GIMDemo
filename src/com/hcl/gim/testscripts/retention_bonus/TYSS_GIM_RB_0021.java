...
/**
 *TestCaseId: TYSS_GIM__0021
 *Claim Type: RetentionBonus
 *TestScript Name: TYSS_GIM_RB_0021
 *Description: Verify the status of GEO HR for 'RetentionBonus' allowance claim after getting referred back by ES2
 *            
 *Author: Abhilash B
 */
public class TYSS_GIM_RB_0021 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from RetentionBonus where SlNo ='21'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description="Description:Verify the status of  'RetentionBonus'  claim after getting referred back by ES2(through the form)")
	public synchronized void TC_TYSS_GIM_RB_0021(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String bonusperiod,String remarks) throws InterruptedException  

	 {
		...
		/*Enter below Details for Retention Bonuse */
		pages.throughTheFormPage.fillTheRetentionBonus(fromDate, toDate, employeeCode, countryCode, companyCode, amount, remarks,bonusperiod, WebActionUtil.getSampleFilePath(prop_app_constants.getProperty("fileFormat_pdf")));
		...
		/****** ES2 Login *******/
		/* Enter User ID and Password of ES2 OnSite and Click on Log In. */
