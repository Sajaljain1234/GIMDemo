...
/**
 *TestCaseId: TYSS_GIM__0014
 *Claim Type: RetentionBonus
 *TestScript Name: TYSS_GIM_RB_0014
 *Description: verify the status of Geo HR after getting referred back by ES1
 *Author: Abhilash B
 */
public class TYSS_GIM_RB_0014 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from RetentionBonus where SlNo ='14'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description="Description:verify the status of Retention Bonus after getting referred back by ES1(Excel upload)")
	public synchronized void TC_TYSS_GIM_RB_0014(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String bonusperiod,String remarks) throws InterruptedException  
