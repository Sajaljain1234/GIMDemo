 ...
 *TestScript Name: TYSS_GIM_EXO_0020
 *Description: Verify the status of the Exgratia others after getting reffered back by GEO HR RM.
 *            
 *Author: Aatish Slathia
 */

public class TYSS_GIM_EXO_0020 extends BaseTest{

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from ExgratiaOthers where SlNo ='20'")
	...
	public synchronized void TC_TYSS_GIM_EXO_0020(String slNo, String employeeCode, String countryCode,
