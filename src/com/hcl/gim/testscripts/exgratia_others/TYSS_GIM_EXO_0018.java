 ...
 * TestScript Name: TYSS_GIM_EXO_0018 
...
public class TYSS_GIM_EXO_0018 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from ExgratiaOthers where SlNo ='18'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Description: Verify the status of the GEO HR after getting the approved by all approver")
	public synchronized void TC_TYSS_GIM_EXO_0018(String slNo, String employeeCode, String countryCode,
