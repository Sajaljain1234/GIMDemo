 ...
 * TestScript Name: TYSS_GIM_EXO_0021 
 * Description: Verify the status of the Exgratia others after
 *              getting reffered back by ES1 Onsite.
 * 
 * Author: Aatish Slathia
 */

public class TYSS_GIM_EXO_0021 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GimTestData_OtherFlows.xlsx", sql = "Select * from ExgratiaOthers where SlNo ='21'")
	...
	public synchronized void TC_TYSS_GIM_EXO_0021(String slNo, String employeeCode, String countryCode,
