 ...
 * TestScript Name: TYSS_GIM_PA_0005
 * Description: Verify the status of LOB HR for 'Patent Award' allowance claim after getting referred back by ES2 OnSite
 * 
 * Author: Sajal jain
 */
public class TYSS_GIM_PA_0005 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from PatentAward where SlNo='5'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Description: Verify the status of LOB HR for 'Patent Award' allowance claim after getting referred back by ES2 OnSite using copy & paste option")
	public void TC_TYSS_GIM_PA_0005(String slNo, String employeeCode, String countryCode, String companyCode,
			String amount, String fromDate, String toDate, String patentId, String remarks){
