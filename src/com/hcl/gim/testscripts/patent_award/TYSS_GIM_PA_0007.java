 ...
 * TestScript Name: TYSS_GIM_PA_0007
 * Description: Verify that user is able to go back to the select claim page after selecting the 'Patent Award' 
 * allowance claim
 * 
 * Author: Sajal jain
 */
public class TYSS_GIM_PA_0007 extends BaseTest {
	@Test(description = "Description: Verify that user is able to go back to the select claim page after selecting the 'Patent Award' allowance claim in copy & paste option")
	public void TC_TYSS_GIM_PA_0007() {
