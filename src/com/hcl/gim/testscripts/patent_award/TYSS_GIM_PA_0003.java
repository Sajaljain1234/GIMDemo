 ...
 * TestScript Name: TYSS_GIM_PA_0003
 * Description: Verify that User is able to cancel the 'Patent Award' allowance claim for which the data has 
 * been uploaded by the LOB HR
 * 
 * Author: Sajal jain
 */
public class TYSS_GIM_PA_0003 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from PatentAward where SlNo='3'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify that User is able to cancel the 'Patent Award' allowance claim for which the data has been uploaded by the LOB HR using copy & paste option")
	public void TC_TYSS_GIM_PA_0003(String slNo,String employeeCode, String countryCode, String companyCode, String amount,
