 ...
 * TestScript Name: TYSS_GIM_PA_0019
 * Description: Verify the status of LOB HR for 'Patent Award' allowance claim after getting referred back by ES2 OnSite
 * 
 * Author: Sajal jain
 */
public class TYSS_GIM_PA_0019 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from PatentAward where SlNo='19'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of LOB HR for 'Patent Award' allowance claim after getting referred back by ES2 OnSite using through the form option" )
	public void TC_TYSS_GIM_PA_0019(String slNo,String employeeCode, String countryCode, String companyCode, String amount,
		...
		pages.throughTheFormPage.fillThePatentAward(fromDate, toDate, employeeCode, countryCode, companyCode, amount,
				remarks, WebActionUtil.getSampleFilePath(prop_app_constants.getProperty("fileFormat_msg")), patentId);
