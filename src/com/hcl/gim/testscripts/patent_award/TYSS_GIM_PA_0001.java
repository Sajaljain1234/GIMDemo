 ...
 * TestScript Name: TYSS_GIM_PA_0001
 * Description: Verify that user is able to download 'Patent Award' allowance form template
 * 
 * Author: Sajal jain
 */
public class TYSS_GIM_PA_0001 extends BaseTest {
	@Test(description = "Description: Verify if user is able to download 'Patent Award' allowance form template in copy & paste option")
	public void TC_TYSS_GIM_PA_0001() {
