 ...
 * TestScript Name: TYSS_GIM_PA_0015
 * Description: Verify that user is able to clear the data for 'Patent Award' allowance claim after valid 
 * data and .msg extension is uploaded
 * 
 * Author: Sajal jain
 */
public class TYSS_GIM_PA_0015 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from PatentAward where SlNo='15'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify that user is able to clear the data for 'Patent Award' allowance claim after valid data and .msg extension is uploaded in excel upload option")
	public void TC_TYSS_GIM_PA_0015(String slNo,String employeeCode, String countryCode, String companyCode, String amount,
