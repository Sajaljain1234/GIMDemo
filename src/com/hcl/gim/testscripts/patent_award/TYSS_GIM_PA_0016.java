 ...
 * TestScript Name: TYSS_GIM_PA_0016
 * Description: Verify the status of LOB HR for 'Patent Award' allowance claim after getting approved by all the approvers
 * 
 * Author: Sajal jain
 */
public class TYSS_GIM_PA_0016 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from PatentAward where SlNo='16'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of LOB HR for 'Patent Award' allowance claim after getting approved by all the approvers using through the form option" )
	public void TC_TYSS_GIM_PA_0016(String slNo,String employeeCode, String countryCode, String companyCode, String amount,
