 ...
 * Name:TYSS_GIM_FB_0015 
 * Description:Verify the status of GEO HR for 'Foundation Bonus Geo' allowance claim after getting approved by all the approvers.
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_FB_0015 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from FoundationBonusGeo where SlNo ='15'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Foundation Bonus' allowance claim after getting approved by all the approvers using through the form option" )
	public void TC_TYSS_GIM_FB_0015(String slNo,String employeeCode, String countryCode, String companyCode,
