 ...
 * Name:TYSS_GIM_FB_0018 
 * Description:Verify the status GEO HR for 'Foundation Bonus Geo' allowance Claim after getting referred back by ES1 OnSite.
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_FB_0018 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from FoundationBonusGeo where SlNo ='18'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Foundation Bonus' allowance claim after getting referred back by ES1 OnSite using through the form option" )
	public void TC_TYSS_GIM_FB_0018(String slNo,String employeeCode, String countryCode, String companyCode,
