 ...
 * Name:TYSS_GIM_FB_0014 
 * Description:Verify the status of GEO HR for 'Foundation
 * Bonus Geo' allowance Claim after getting referred back by ES2 OnSite.
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_FB_0014 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from FoundationBonusGeo where SlNo ='14'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Foundation Bonus' allowance claim after getting referred back by ES2 OnSite using excel upload option" )
	public void TC_TYSS_GIM_FB_0014(String slNo,String employeeCode, String countryCode, String companyCode,
