 ...
 * Name:TYSS_GIM_FB_0008 
 * Description:Verify the status of GEO HR for 'Foundation Bonus Geo' allowance claim after getting referred back by ES2 onsite.
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_FB_0008 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from FoundationBonusGeo where SlNo ='8'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Foundation Bonus' allowance claim after getting referred back by ES2 OnSite using copy & paste option")
	public void TC_TYSS_GIM_FB_0008(String slNo,String employeeCode, String countryCode, String companyCode,
		...
		/*
		 * Click on View document icon of the claim and validate the file got download
		 */
		pages.pendingActionsPage.clickOnViewDocumentIcon(claimId,
				WebActionUtil.getSampleFileName(prop_app_constants.getProperty("fileFormat_jpg")),
				prop_app_constants.getProperty("fileFormat_jpg"));
		...
		/* Expected history after GEO HR RM approval */
