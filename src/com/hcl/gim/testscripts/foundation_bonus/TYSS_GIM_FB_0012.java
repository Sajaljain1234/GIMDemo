 ...
 * Name:TYSS_GIM_FB_0012 
 * Description:Verify the status of GEo HR for 'Foundation Bonus Geo' allowance claim 
 * after getting referred back by GEO HR RM.
 * 
 * @author Suganthini
 *
 */
public class TYSS_GIM_FB_0012 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from FoundationBonusGeo where SlNo ='12'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Foundation Bonus' allowance claim after getting referred back by GEO HR RM OnSite using excel upload option" )
	public void TC_TYSS_GIM_FB_0012(String slNo,String employeeCode, String countryCode, String companyCode,
