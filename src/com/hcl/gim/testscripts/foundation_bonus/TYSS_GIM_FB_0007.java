 ...
 * Name:TYSS_GIM_FB_0007 
 * Description:Verify the status of GEO HR for 'Foundation Bonus Geo' allowance claim after getting referred back by ES1 Onsite.
 * 
 * @author Suganthini
 *
 */

public class TYSS_GIM_FB_0007 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from FoundationBonusGeo where SlNo ='7'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Foundation Bonus' allowance claim after getting referred back by ES1 OnSite using copy & paste option" )
	public void TC_TYSS_GIM_FB_0007(String slNo,String employeeCode, String countryCode, String companyCode,
