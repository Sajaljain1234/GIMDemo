 ...
 *
 */
public class TYSS_GIM_FB_0010 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql = "Select * from FoundationBonusGeo where SlNo ='10'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Foundation Bonus' allowance claim after getting approved by all the approvers using excel upload option")
	public void TC_TYSS_GIM_FB_0010(String slNo,String employeeCode, String countryCode, String companyCode,
