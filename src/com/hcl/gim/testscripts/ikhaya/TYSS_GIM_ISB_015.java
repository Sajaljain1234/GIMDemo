...
/**
 *TestCaseId: TYSS_GIM_015
 *Claim Type: Ikahya safety bonus
 *TestScript Name: TYSS_GIM_ISB_015
...
public class TYSS_GIM_ISB_015 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql="Select * from Ikahyasafetybonus where SlNo='15'")
	...
	public synchronized void TC_TYSS_GIM_ISB_015(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String rate,String noofInstalments,String remarks) throws InterruptedException {
