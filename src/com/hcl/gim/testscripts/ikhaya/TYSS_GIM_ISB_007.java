...
/**
 *TestCaseId: TYSS_GIM_007
 *Claim Type: Ikahya safety bonus
 *TestScript Name: TYSS_GIM_ISB_007
 *Description: Verify the status of GEO HR for 'Ikahya safety bonus(client-seriti/elango) ' allowance Claim  after getting referred back by Rejected by GEO HR RM.
 *            
 *Author: Manish Kumar C D
 */

public class TYSS_GIM_ISB_007 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql="Select * from Ikahyasafetybonus where SlNo='7'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Ikahya safety bonus(client-seriti/elango) ' allowance Claim  after getting referred back by Rejected by GEO HR RM." )
	public synchronized void TC_TYSS_GIM_ISB_007(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String rate,String noofInstalments,String remarks) throws InterruptedException {
