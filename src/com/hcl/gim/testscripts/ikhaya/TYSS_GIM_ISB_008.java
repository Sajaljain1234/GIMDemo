...
/**
 *TestCaseId: TYSS_GIM_008
 *Claim Type: Ikahya safety bonus
 *TestScript Name: TYSS_GIM_ISB_008
 *Description: Verify the status of GEO HR for 'Ikahya safety bonus(client-seriti/elango) ' allowance Claim  after getting referred back by ES1 OnSite.
 *            
 *Author: Manish Kumar C D
 */


public class TYSS_GIM_ISB_008 extends BaseTest{

	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql="Select * from Ikahyasafetybonus where SlNo='8'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify the status of GEO HR for 'Ikahya safety bonus(client-seriti/elango) ' allowance Claim  after getting referred back by ES1 OnSite." )
	public synchronized void TC_TYSS_GIM_ISB_008(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String rate,String noofInstalments,String remarks) throws InterruptedException {
