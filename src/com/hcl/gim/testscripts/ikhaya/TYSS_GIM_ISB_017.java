...
/**
 *TestCaseId: TYSS_GIM_017
 *Claim Type: Ikahya safety bonus
 *TestScript Name: TYSS_GIM_ISB_017
...
public class TYSS_GIM_ISB_017 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql="Select * from Ikahyasafetybonus where SlNo='17'")
	...
	public synchronized void TC_TYSS_GIM_ISB_017(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String rate,String noofInstalments,String remarks) throws InterruptedException {
		...
		/*Enter the remarks in Remarks textareafield*/
		pages.pendingActionsPage.setApproveRemark(prop_app_constants.getProperty("approveRemark"));
