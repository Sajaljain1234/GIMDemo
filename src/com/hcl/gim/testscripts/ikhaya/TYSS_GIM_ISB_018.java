...
/**
 *TestCaseId: TYSS_GIM_018
 *Claim Type: Ikahya safety bonus
 *TestScript Name: TYSS_GIM_ISB_018
 *Description: Verify that the status of GEO HR for 'Ikahya safety bonus(Client-seriti/elango) allowance' Claim after getting approved by all the approvers.
 *            
 *Author: Manish Kumar C D
 */

public class TYSS_GIM_ISB_018 extends BaseTest{
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql="Select * from Ikahyasafetybonus where SlNo='18'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class,description = "Description: Verify that the status of GEO HR for 'Ikahya safety bonus(Client-seriti/elango) allowance' Claim after getting approved by all the approvers.")
	public synchronized void TC_TYSS_GIM_ISB_018(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String rate,String noofInstalments,String remarks) throws InterruptedException {
		...
		pages.throughTheFormPage.fillTheIkahyaSafetybonus(fromDate, toDate, employeeCode, countryCode, companyCode, amount, remarks, noofInstalments, rate, WebActionUtil.getSampleFilePath(prop_app_constants.getProperty("fileFormat_jpg")));
