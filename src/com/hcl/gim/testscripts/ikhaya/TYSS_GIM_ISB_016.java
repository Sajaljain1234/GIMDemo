...
/**
 *TestCaseId: TYSS_GIM_016
 *Claim Type: Ikahya safety bonus
 *TestScript Name: TYSS_GIM_ISB_016
...
public class TYSS_GIM_ISB_016 extends BaseTest {
	@DataProviderFileRowFilter(file = "./data/GIMTestData_OtherFlows.xlsx", sql="Select * from Ikahyasafetybonus where SlNo='16'")
	...
	public synchronized void TC_TYSS_GIM_ISB_016(String slNo,String employeeCode,String countryCode,String companyCode,String amount,String fromDate,String toDate,String rate,String noofInstalments,String remarks) throws InterruptedException {
		...
		pages.initiateClaimPage.clkExcelUploadorDragandDropyourfileshereLink(WebActionUtil.getSampleFilePath(prop_app_constants.getProperty("fileFormat_msg")));
		...
		/*Enter the remarks for refer back in remarks textareafield*/
